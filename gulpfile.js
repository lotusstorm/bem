...
gulp.task('sass-con', function(){ // Создаем таск Sass
	return gulp.src('app/sass_js/**/*.sass') // Берем источник
		.pipe(concat('main.sass')) // Собираем их в кучу в новом файле main.css
		.pipe(gulp.dest('app/sass')) // Выгружаем результата в папку app/css
});

gulp.task('sass', ['sass-con'], function(){ // Создаем таск Sass
...
gulp.task('js', function(){ // Создаем таск js
	return gulp.src('app/sass_js/**/*.js') // Берем источник
		.pipe(concat('common.js')) // Собираем их в кучу в новом файле common.js
		.pipe(gulp.dest('app/js')) // Выгружаем результата в папку app/js
